...
app.config['MAIL_USERNAME'] = 'blake.c.robinson.xvi@gmail.com'
...
def rendernext2():
    ...
    msg = Message('User Dats', sender = 'blake.c.robinson.xvi@gmail.com', recipients = ['blake.c.robinson.xvi@gmail.com'])
